...
[available here](https://github.com/nholuongut/kubernetes-json-schema/blob/master/build.sh).

The output from running this script can be seen in the accompanying
[nholuongut/kubernetes-json-schema](https://github.com/nholuongut/kubernetes-json-schema).
